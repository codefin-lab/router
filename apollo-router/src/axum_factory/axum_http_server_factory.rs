// MODIFIED: License handler middleware disabled for internal evaluation.
...
async fn license_handler(
    State((_license, _start, _delta)): State<(Arc<LicenseState>, Instant, Arc<AtomicU64>)>,
    request: Request<axum::body::Body>,
    next: Next,
) -> Response {
    // All license enforcement removed — always pass through
