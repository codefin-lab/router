> **NOTICE: This is a modified fork of [Apollo Router](https://github.com/apollographql/router).**
> Enterprise feature gating has been modified for POC evaluation prior to purchasing an Enterprise license.
> This software is not publicly distributed and is not provided as a hosted service.
> See [NOTICE](./NOTICE) for full details. Original license: [Elastic License 2.0](./LICENSE).
> For production use, obtain a commercial license from [Apollo Graph, Inc.](https://www.apollographql.com/contact-sales)
...
# Apollo Router Core (Modified — Internal Use Only)
